...
```{r}
# Your code here
# Start with writing down equations

# 1. Calculate utility for each choice
Ua - utility auto 0.237573*0 + -0.053110*Time_Auto
Ut - utility transit 0.237573*1 + -0.053110*Time_Auto

#2. Calculate probability for each choice based on utility
Pa - exp(Ua)/exp(Ua)+exp(Ut)
Pt - exp(Ut)/exp(Ua)+exp(Ut)

# 3. Create Expected column based on probability column - larger probability

# 4. Compare Expected with Choice and put TRUE if they are the same /FALSE if not.
